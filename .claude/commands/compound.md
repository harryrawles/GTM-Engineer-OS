...
- **PRR gate:** if PRR < 1%, ask the GTME: "PRR is [x]% - below 1% threshold. Log anyway as a notable test result?" If yes, log under "Notable Results" subsection, not Top Performers.
