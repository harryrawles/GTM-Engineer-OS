# First Principles of Client Acquisition
...
already understood the fundamentals, you'd have already built your own system from scratch.
...
## 1. First Principles: Human + Stimulus = Action

Three irreducible parts of client acquisition:

| Part | Definition |
|------|-----------|
| **Human** | The person we want to attract as a client |
| **Stimulus** | Something we expose the human to, to produce an action |
| **Action** | The human behaving in a way that moves them toward becoming a client |

```
Human + Stimulus = Action
```

Examples of stimulus → action pairs:

| Stimulus | Action it produces |
|----------|-------------------|
| Subject line | Gets someone to open an email |
| First line | Gets someone to read the email |
| Case study | Gets someone to believe it works |
| Emotional sales question | Gets someone to share information that helps close them |
| Calendar link | Gets someone to book a call |
...
```
clicking vid > watching vid > reading description > clicking link > watching video >
believing social proof > clicking a button to schedule > selecting a time >
providing qualifying information > watching interviews > showing up for call >
agreeing to agenda > answering questions > listening to pitch > asking questions >
raising objections > listening to rebuttals > being convinced > making a decision >
clicking link to pay > filling out card information > pressing button to pay
```
...
fundamentals, or none at all. The soundness of the fundamental underneath a stimulus is the real predictor
of whether the stimulus performs.

---

## 3. Stimulus Hunters vs Fundamental Seekers

The single biggest mistake in learning client acquisition: looking for stimuli instead of fundamentals.
...
- That email copy stops getting replies
- That sales script stops converting
...
## 5. Cyclical Stimulus Effectiveness & Contrarian Attraction

About 95% of people trying to acquire clients are Stimulus Hunters, which means 95% of a niche converges
on the same handful of tactics at any given time. That's reliable enough to build a strategy around.

**The cycle:** a stimulus is novel → it works → more people copy it → it over-exposes → Hypoesthesia and
...
|----------|------------|
| **Business** | Accounting, **Sales**, Economics, Finance, Management, Marketing |
| **Humanities** | Art, History, Languages, Literature, Music, **Philosophy**, Religion, Theatre |
| **Natural & Applied Sciences** | **Biology**, **Statistics**, **Scientific method**, Chemistry, Computer science, Engineering, Geology, Mathematics, Physics, Medicine, **Systems** |
| **Social Sciences** | Anthropology, **Economics**, Game Theory, Education, Geography, Law, Political science, **Psychology** |
...
## 10. Stimuli-Based (Psychological) Fundamentals
...
Strip away every piece of proven copy, every script, every SOP in this repo, and the fundamentals in this
file are what let you rebuild all of it from scratch. Stimuli are disposable and expected to die on a
schedule (Section 4). Fundamentals are not.
