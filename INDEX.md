...
|------|----------------|
| company/overview.md | Who the client is, what they do, why they hired Instantly.ai |
| company/icp.md | Target ICP, signal priority, lead filters, avoid list |
...
| File | What it contains |
|------|----------------|
| raw/onboarding-intake.md | Completed intake form from onboarding call |