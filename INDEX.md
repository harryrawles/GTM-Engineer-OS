...
| .claude/skills/ | Vendored third-party Claude Skill packages (Anthropic's official format), invocable directly - see `.claude/skills/README.md`. Currently: `skill-creator/`, for drafting and iterating new skills. Distinct from `gtm-skills/`, which is this OS's own markdown routing convention. |
