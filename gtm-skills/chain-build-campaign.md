...
This chain is the cold-email channel's answer to the general 6-step build process in
`wiki/system-design-process.md` - see that file's Section 7 for exactly which sub-skill answers which
