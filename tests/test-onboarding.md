...
- Read company/*.md and detect all blank/template
...
- Files written in correct locations (company/ not wiki/)
...
- Files written to wrong location (e.g. company/copy-library to wiki/)
