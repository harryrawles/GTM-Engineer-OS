...
Numbers and named logos beat vague claims. Use these in copy.
...
## The 3 Value Props (for rotating across emails)

Every B2B offer does one of three things. Assign each value prop a specific angle for this client.

| Value prop | This client angle |
|-----------|------------------|
| Make money | {{How this offer helps them earn more}} |
| Save time | {{How this offer saves time / removes manual work}} |
| Save money | {{How this offer cuts costs or removes spend}} |
...
{{Any nuance on offer positioning, things the client is sensitive about, angles that have worked or failed before.}}