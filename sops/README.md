...
- `client-handover.md` - transitioning an existing client to a new or covering GTME: the Handover Brief,
  the three scenarios (permanent departure, internal reassignment, temporary cover), and the client
  communication template for each. Generated by `gtm-skills/handover-brief-writer.md`.
